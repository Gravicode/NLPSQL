...
namespace SemanticKernel.Data.NlpSql.Library;
...
using SemanticKernel.Data.NlpSql.Library.Internal;
...
public sealed class SqlQueryGenerator
{
    ...
    public SqlQueryGenerator(IKernel kernel, string rootSkillFolder, double minRelevanceScore = DefaultMinRelevance)
    {
        ...
        this.MinRelevance = minRelevanceScore;
    ...
    public async Task<string?> SolveObjectiveAsync(string objective, SKContext context)
    {
        ...
        var recall =
            await this._memory.SearchAsync(
                ...
                objective,
                limit: 1,
                minRelevanceScore: this.MinRelevance,//0.6,
